    ...
    factory.radientStrHeroes = [
        {
            ...
            strengths: [
                { title: 'Farms quickly', icon: '../css/images/ability-icons/Greevil\'s_Greed_icon.png', description: 'With Greevel\'s Greed, Alchemist has the potential to print gold faster than any other hero. Coupled with other farming items such as Hand of Midas, Battle Fury, or Radiance, Alch will outfarm any hero in the early and mid game.', },
                { title: 'Difficult to kill', icon: '../css/images/ability-icons/Chemical_Rage_icon.png', description: 'Alchemist has incredible recovery under the effects of his ultimate, often healing faster than a single (or even two or three) hero can damage him.', },
            ],
            weaknesses: [
