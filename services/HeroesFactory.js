    ...
    factory.radientStrHeroes = [
        {
            ...
            strengths: [
                { title: 'Difficult to kill', icon: '../css/images/ability-icons/durable.png', },
                { title: 'Farms quickly', icon: '../css/images/ability-icons/cleave.png', },
            ],
            weaknesses: [
                { title: 'Ancient Apparition: Ice Blast', icon: '../css/images/ability-icons/Ice-Blast.png' },
                { title: 'Stun', icon: '../css/images/ability-icons/stun.png' },
            ],
            showProfile: false,
        },
        {
